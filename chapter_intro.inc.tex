...
If you have long inline verbatim text and you need to split the text, use \texttt{\textbackslash{}seqsplit}. Notice the difference:

\begin{itemize}
\item using \texttt{\textbackslash{}seqsplit} : \texttt{\seqsplit{long\_function\_name\_within\_\_the\_texttt\_command\_that\_usually\_does\_not\_split\_at\_the\_end\_of\_the\_line}}.
\item without using \texttt{\textbackslash{}seqsplit} : \texttt{long\_function\_name\_within\_\_the\_texttt\_command\_that\_usually\_does\_not\_split\_at\_the\_end\_of\_the\_line}.
\end{itemize}
